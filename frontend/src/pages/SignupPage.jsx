      ...
      <div className="relative w-full max-w-lg px-6 sm:px-8">
        <div className="bg-parchment/95 backdrop-blur-md rounded-3xl shadow-2xl gold-border p-8 sm:p-12 animate-fade-in">
          ...
          <div className="text-center mb-8 sm:mb-10">
            <h1 className="text-4xl sm:text-5xl font-bold font-serif text-deep tracking-wide">Join Socrates</h1>
            <p className="mt-4 text-deep/70 text-base sm:text-lg font-medium">Begin Your Pursuit of Truth</p>
          </div>
